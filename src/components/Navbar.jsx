...
import cov from '../assets/avt.png'
  ...
  return (
    <div className='fixed z-50  w-full top-0 left-0 px-8 py-4 lg:px-20 xl:px-36'>
        <div className="flex justify-between items-center text-white">
            ...
            <li><a href="#" className='hover:scale-105 transition-all duration-500 cursor-pointer' >
            ...
            onClick={() => window.open('https://drive.google.com/file/d/1ApeCeb_pdkRss2wuL53S_u11AqqwxIv-/view?usp=drive_link', '_blank')}
>
  Resume
</button>
